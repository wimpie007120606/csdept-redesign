...
export const fallbackPeople = [
  ...
  { id: 'willem-visser', slug: 'willem-visser', name: 'Prof. Willem Visser', primaryTitle: 'Professor', secondaryTitle: 'Academic Staff', department: 'Computer Science Division, Department of Mathematical Sciences', institution: 'Stellenbosch University', image: willemVisserImage, researchAreas: ['Testing', 'Program analysis', 'Symbolic execution', 'Probabilistic symbolic execution', 'Model checking', 'Java PathFinder (JPF)', 'Symbolic PathFinder (SPF)'] },
